...
# the function return the mesh information
    ...
    NSetDict = Dict{String,Array{Int64,1}}()
        ...
        if Strtemp[end]=="generate"
            ...
            for knode = 1:NodeTotal
                ...
                try
                    ...
                    println("the nset "*NSetName*" seems not a set defined by nodal id.")
                    break
                end
            end
        end
        ...
        if Strtemp[end]=="generate"
            ...
            for kelem = 1:ElemTotal
                ...
                try
                    ...
                    println("the elset "*ElSetName*" seems not a set defined by nodal id.")
                    break
                end
            end
        end
